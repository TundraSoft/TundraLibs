...
Deno.test('guardian.NumberGuardian', async (t) => {
  await t.step('basic functionality', async (u) => {
    await u.step('should validate number type', () => {
    ...
    await u.step('should reject NaN', () => {
      const schema = new NumberGuardian();
      asserts.assertThrows(() => schema.parse(NaN), GuardianError);
    });

    await u.step('should accept Infinity', () => {
      const schema = new NumberGuardian();
  ...
  await t.step('range validations', async (u) => {
    ...
    await u.step('should validate range (inclusive)', () => {
  ...
  await t.step('sign validations', async (u) => {
    await u.step('should validate positive numbers', () => {
    ...
    await u.step('should validate negative numbers', () => {
  ...
  await t.step('integer and finite validations', async (u) => {
    await u.step('should validate integers', () => {
    ...
    await u.step('should validate finite numbers', () => {
    ...
    await u.step('should validate safe integers', () => {
  ...
  await t.step('multipleOf validation', async (u) => {
    await u.step('should validate multiples', () => {
    ...
    await u.step('should work with decimal multiples', () => {
  ...
  await t.step('advanced validations', async (u) => {
    await u.step('should validate odd numbers', () => {
    ...
    await u.step('should validate even numbers', () => {
    ...
    await u.step('should validate prime numbers', () => {
    ...
    await u.step('should validate non-zero numbers', () => {
    ...
    await u.step('should validate port numbers', () => {
    ...
    await u.step('should validate timestamp numbers', () => {
  ...
  await t.step('mathematical transformations', async (u) => {
    await u.step('should round numbers', () => {
    ...
    await u.step('should floor numbers', () => {
    ...
    await u.step('should ceil numbers', () => {
    ...
    await u.step('should truncate numbers', () => {
    ...
    await u.step('should negate numbers', () => {
    ...
    await u.step('should clamp numbers to range', () => {
    ...
    await u.step('should round to fixed decimal places', () => {
  ...
  await t.step('type transformations', async (u) => {
    await u.step('should convert number to string', () => {
    ...
    await u.step('should convert number to string with radix', () => {
    ...
    await u.step('should convert number to BigInt', () => {
    ...
    await u.step('should convert number to Date', () => {
  ...
  await t.step('nullable and optional', async (u) => {
    await u.step('should handle nullable numbers', () => {
    ...
    await u.step('should handle optional numbers', () => {
    ...
    await u.step('should handle optional with function default', () => {
      let callCount = 0;
      const schema = new NumberGuardian().positive().optional(() => {
        callCount++;
        return 100;
    ...
    await u.step('should work with validations', () => {
  ...
  await t.step('complex chaining scenarios', async (u) => {
    await u.step('should chain new methods with existing ones', () => {
      const schema = new NumberGuardian()
        .range(1, 1000)
        .odd()
        .prime()
    ...
    await u.step('should chain transformations with validations', () => {
      const schema = new NumberGuardian()
  ...
  await t.step('new validation methods', async (u) => {
    ...
    await u.step('power validation with specific base', () => {
    ...
    await u.step('between validation exclusive', () => {
    ...
    await u.step('latitude validation', () => {
    ...
    await u.step('longitude validation', () => {
  ...
  await t.step('new transformation methods', async (u) => {
    await u.step('formatCurrency transformation', () => {
    ...
    await u.step('formatCurrency with different locale', () => {
    ...
    await u.step('formatPercentage transformation', () => {
    ...
    await u.step('formatPercentage with custom decimals', () => {
    ...
    await u.step('addCommas transformation', () => {
    ...
    await u.step('padZeros transformation', () => {
    ...
    await u.step('padZeros with different lengths', () => {
  ...
  await t.step('nullable and optional scenarios for new methods', async (u) => {
    await u.step('nullable power validation', () => {
    ...
    await u.step('optional between validation', () => {
    ...
    await u.step('optional with default formatPercentage', () => {
    ...
    await u.step('nullable latitude validation', () => {
  ...
  await t.step('chaining with new methods', async (u) => {
    await u.step('complex validation chain', () => {
      const schema = new NumberGuardian()
        .positive()
        .between(1, 1000)
        .integer()
    ...
    await u.step('transformation chain', () => {
      const schema = new NumberGuardian()
        .abs()
        .clamp(0, 100)
        .formatPercentage(1);
    ...
    await u.step('geographic coordinate validation', () => {
