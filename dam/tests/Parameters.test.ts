...
describe('DAM', () => {
  describe('Parameters', () => {
    it('should create a parameter and return its name', () => {
    ...
    it('should return the same name for the same value', () => {
      const params = new Parameters('XXXXX');
      const param1 = params.create('value1');
    ...
    it('should return the correct size of parameters', () => {
      const params = new Parameters('XXXXX');
    ...
    it('should return parameters as a record', () => {
      const params = new Parameters('XXXXX');
      params.create('value1');
      params.create('value2');
      params.create('value3');
    ...
    it('handle different data types correctly', () => {
      const params = new Parameters('XXXXX');
      const d = new Date();
      params.create('value1');
      params.create(123);
