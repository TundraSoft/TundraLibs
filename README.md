...
- **[Rapid](packages/rapid/README.md)** [![JSR](https://jsr.io/badges/@tundralibs/rapid)](https://jsr.io/@tundralibs/rapid) — rAPId — config-driven application framework: HTTP routes, WebSocket commands and cron jobs behind one middleware onion, decorated modules, an HTML-over-the-wire UI layer, native observability (slogger, tracer, ambient correlation) and pact authentication.
