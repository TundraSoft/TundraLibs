...
- **[Pact](packages/pact/README.md)** [![JSR](https://jsr.io/badges/@tundralibs/pact)](https://jsr.io/@tundralibs/pact) — Permissions, Authentication, Control & Tokens — a transport-agnostic auth toolkit with BigInt-bitmask authorization, flat storage hooks, five credential schemes, refresh-token rotation, TOTP, and an OAuth2/OIDC client
