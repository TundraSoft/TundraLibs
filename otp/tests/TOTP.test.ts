...
describe(`[library='otp' mode='TOTP' algorithm='SHA-512']`, () => {
  ...
  it('RFC-6238 Specification Test Vectors - SHA-1', async () => {
    const data = {
      59000: '287082',
  ...
  it('RFC-6238 Specification Test Vectors - SHA-256', async () => {
    const data = {
      59000: '46119246',
  ...
  it('RFC-6238 Specification Test Vectors - SHA-512', async () => {
    const data = {
      59000: '90693936',
