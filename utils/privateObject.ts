 ...
 * @example
 * ```ts
 * const obj = privateObject<Record<string, unknown>>({ key: 'value' });
 * obj.get('key'); // 'value'
 * obj.set('key', 'new value');
 * obj.get('key'); // 'new value'
 * obj.has('key'); // true
 * obj.forEach((key, value) => console.log(key, value));
 * obj.delete('key');
 * console.log(obj.has('key')); // false
 * obj.set('keyf', 'new value');
 ...
 * @example
 * ```ts
 * const obj = privateObject<Record<string, unknown>>({ key: 'value' }, false);
 * obj.get('key'); // 'value'
 * obj.set('key', 'new value');
