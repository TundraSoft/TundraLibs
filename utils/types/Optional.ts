 ...
 * type ProductUpdate = Optional<Product, Exclude<keyof Product, 'id'>>;
 * // or more specifically:
 * type ProductPatch = Optional<Product, 'name' | 'price' | 'description' | 'category' | 'inStock'>;
 *
 ...
 * type SearchRequest = Optional<SearchParams, 'page' | 'limit' | 'sortBy' | 'sortOrder'>;
 *
 ...
 * type DatabaseOptions = Optional<DatabaseConfig, 'ssl' | 'maxConnections' | 'timeout'>;
 *
 ...
 * type BasicRegistration = Optional<RegistrationForm,
 *   'firstName' | 'lastName' | 'birthDate' | 'newsletter' | 'marketingEmails'>;
 *
 * // Step 2: Only marketing preferences optional
 * type CompleteRegistration = Optional<RegistrationForm, 'newsletter' | 'marketingEmails'>;
 *
 ...
 * type CreateEntityRequest = Optional<
 *   Omit<ApiEntity, 'id' | 'createdAt' | 'updatedAt'>,
 *   'description'
 * >;
 *
 * // For updates: make everything except id optional
 * type UpdateEntityRequest = Optional<ApiEntity, Exclude<keyof ApiEntity, 'id'>>;
 *
 * // Usage:
