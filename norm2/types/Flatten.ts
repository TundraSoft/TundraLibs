...
type NumberOperators<ValueType extends number | bigint> =
  | CommonOperators<ValueType>
  | {
    $lt?: ValueType;
    $lte?: ValueType;
    $gt?: ValueType;
...
type StringOperators<ValueType extends string = string> =
  | CommonOperators<ValueType>
  | {
    $like?: ValueType;
    $nlike?: ValueType;
...
type FilterOperators<T> = T extends string ? StringOperators<T>
  ...
  : T extends bigint ? NumberOperators<T>
  : T extends Date ? DateOperators<T>
  : T extends boolean ? CommonOperators<T>
  : T extends unknown
