...
import { password, webSafe } from './const/mod.ts';
...
/**
 * @param size The size of the password to generate
 * @returns The generated password
 */
export function passwordGenerator(size = 21): string {
  return nanoid(size, password);
}
