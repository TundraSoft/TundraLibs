...
export class Syslog {
  ...
  protected _structuredData: Record<string, StructuredData> = {};
  ...
  getStructuredData(id: string): StructuredData | undefined {
    if (this._structuredData[id] !== undefined) {
      return this._structuredData[id];
    }
  }
   ...
   */
  getAllStructuredData(): Record<string, StructuredData> {
  ...
  unsetStructuredData(id: string) {
    if (this._structuredData[id] !== undefined) {
      delete this._structuredData[id];
    }
  }
  ...
  hasStructuredData(id: string): boolean {
    return this._structuredData[id] !== undefined;
  }
  /**
  ...
  hasAnyStructuredData(): boolean {
    return Object.keys(this._structuredData).length > 0;
  }
   ...
   * @returns string
   */
  toString(format: string = Formats.RFC5424) {
    ...
    let sd = '-';
    //#region Structured Data
    if (Object.keys(this._structuredData).length > 0) {
      sd = '';
      Object.entries(this._structuredData).forEach(([id, data]) => {
