...
export class Model<S extends ModelDefinition,
    ...
    protected _columnType: Record<keyof T,
    ...
    constructor(model: S) {
        ...
        const columnDefinition: Partial<Record<keyof T,
            {
                type: DataType;
        ...
        this._columnType = columnDefinition as Record<keyof T,
            { type: DataType; length?: { precision: number; scale: number } | number }>;
