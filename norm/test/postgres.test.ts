...
import {CountQueryOptions, DataTypes, SelectQueryOptions} from "../types/mod.ts";
...
Deno.test({
    ...
    async fn() {
        ...
        assertEquals(result.columns.district.uniqueKey && result.columns.district.uniqueKey.has("city_unique"), true);
