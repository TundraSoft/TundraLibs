...
| ---------------------- | ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------- |
| [blog](./blog)         | 8001 | The full stack: decorated modules in files, `@tundralibs/norm` + SQLite, DI via `@tundralibs/doctor`, events, a cron job, a socket module, pact auth, endpoints, the API reference at `/docs` | `deno run -A packages/rapid/examples/blog/main.ts`      |
