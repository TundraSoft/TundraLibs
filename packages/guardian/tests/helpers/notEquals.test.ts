 ...
 */
describe('guardian.helpers.notEquals', () => {
  ...
  describe('Type safety and special values', () => {
    ...
    it('should handle NaN correctly', () => {
      const nanValidator = notEquals(Number.NaN);
      // NaN !== NaN, so NaN should pass the notEquals test
      asserts.assertEquals(nanValidator(Number.NaN), Number.NaN);
      asserts.assertEquals(nanValidator(42 as any), 42 as any);
    });
  });

  describe('Object and array inequality', () => {
