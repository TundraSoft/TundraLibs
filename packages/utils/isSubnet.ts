/**
 * @fileoverview Subnet CIDR notation validation for IPv4 and IPv6.
 *
 * This module validates whether a string represents a valid subnet in CIDR notation.
 * It performs comprehensive validation of both the IP address portion and the subnet
 * mask, supporting IPv4 (/0-/32) and IPv6 (/0-/128) address families.
 *
 * @module
 *
 * @example
 ...
 * isSubnet('192.168.1.1');     // false - missing CIDR
 * ```
 */
