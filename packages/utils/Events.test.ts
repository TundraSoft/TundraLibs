...
describe('utils.Events', () => {
  ...
  it('should register and emit typed events', () => {
    type EventMap = {
  ...
  it('should call _emit via subclass for events with no listeners', () => {
    ...
    // _emit on event with no listeners should return this
    const result = emitter.fire();
    asserts.assertStrictEquals(result, emitter);
  });

  it('should call _emit via subclass and invoke registered listeners', () => {
