...
describe('utils.isInSubnet', () => {
  it('IPv4 - should handle valid subnets', () => {
    const tests = [
  ...
  it('IPv6 - should handle valid subnets', () => {
    const tests = [
  ...
  it('IPv6 - should handle compressed notation', () => {
  ...
  it('IPv6 - should handle boundary cases', () => {
  ...
  it('should handle mixed IP versions', () => {
  ...
  it('should handle specific edge cases in CIDR parsing', () => {
  ...
  it('IPv4 - should handle non-standard CIDR notations', () => {
  ...
  it('IPv6 - should handle IPv4-mapped IPv6 addresses', () => {
    asserts.assertEquals(
  ...
  it('IPv6 - should handle special address types', () => {
  ...
  it('should handle malformed but similar inputs', () => {
    // CIDR with space
    asserts.assertEquals(
      isInSubnet('192.168.0.1', '192.168.0.0 /24'),
      false,
  ...
  it('should handle error cases and edge cases', () => {
  ...
  it('should handle CIDR parsing edge cases', () => {
  ...
  it('should handle error cases that trigger catch block', () => {
  ...
  it('should handle parameter type validation', () => {
  ...
  it('should handle IPv4 validation edge cases', () => {
  ...
  it('should handle edge cases in CIDR parsing', () => {
  ...
  it('should handle additional error cases', () => {
  ...
  it('should test regex boundary cases', () => {
  ...
  it('should handle boundary CIDR values comprehensively', () => {
  ...
  it('round-3 #1 - mixed IPv6/IPv4 membership is correct (SSRF)', () => {
    // A NAT64-style mixed address with hex groups on both sides of `::`. The
    // buggy expansion misplaced the zero-fill, so isInSubnet denied real
    // members and admitted non-members. Both notations of the same address
    // must classify identically.
    asserts.assertEquals(
      isInSubnet('64:ff9b::1:1.2.3.4', '64:ff9b:0:0:0:1::/96'),
      true,
      'true member must be admitted',
    );
    asserts.assertEquals(
      isInSubnet('64:ff9b::1:102:304', '64:ff9b:0:0:0:1::/96'),
      true,
      'pure-hex spelling of the same address must match too',
    );
    asserts.assertEquals(
      isInSubnet('64:ff9b::1:1.2.3.4', '64:ff9b:1::/96'),
      false,
      'non-member must not be admitted',
    );
  });
});
