...
describe(
  ...
  () => {
    it('should create a CacherEngineError instance', () => {
    ...
    it('should handle CONFIG_MISSING with template variables', () => {
    ...
    it('should handle CONFIG_INVALID with template variables', () => {
      const meta: CacherErrorMeta = {
        name: 'redisCache',
        engine: 'redis',
        configKey: 'port',
    ...
    it('should handle nested CacherEngineError causes', () => {
    ...
    it('should inherit from CacherError correctly', () => {
    ...
    it('should handle multiple invalid codes correctly', () => {
      const meta: CacherErrorMeta = { name: 'cache1', engine: 'memory' };
    ...
    it('should validate all error codes exist', () => {
    ...
    it('should handle partial template variables', () => {
      const meta: CacherErrorMeta = {
        name: 'cache1',
        engine: 'redis',
        configKey: 'host',
