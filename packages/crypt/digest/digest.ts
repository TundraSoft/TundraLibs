/**
 * @fileoverview Cryptographic digest (hashing) functions.
 *
 * Provides secure hash functions using the Web Crypto API including
 * SHA-1, SHA-256, SHA-384, and SHA-512 with hex or base64 encoding.
 *
 * @module
 *
 * @example
