...
**Object Query Language (OQL)** — a type-safe, database-agnostic query builder: define a query once and translate it to SQL (PostgreSQL, MariaDB, SQLite) or MongoDB.
