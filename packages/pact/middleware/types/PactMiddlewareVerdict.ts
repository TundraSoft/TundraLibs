...
> =
  | {
    ...
    /**
     * Present only when the response must be signed or encrypted for
     * this caller: call it with the finished response after the handler
     * ran and apply the patch before sending. Absent → send as-is.
     */
