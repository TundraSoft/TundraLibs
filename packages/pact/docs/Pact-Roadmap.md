...
| HMAC replay protection                       | Middleware enforces a timestamp window and carries a nonce; uniqueness is the app's            | A nonce store hook: reject a seen nonce within the window                                                                    |
