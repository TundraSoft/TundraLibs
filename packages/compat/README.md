...
| `file`, `watch`, `udp`          |      throws       | Need a real filesystem or a UDP socket, neither of which Workers or the browser has. Each public entry throws `UnsupportedRuntimeError` (not a `TypeError`) when the backing built-in is absent.                                                                                                                                                                                                                                                                                                                                                                                                  |
